const globalMoviesData = [
    ...
    "desc": "حلقة خاصة تعيد سرد الجزء الأول من سلسلة ديث نوت بلغة بصرية جديدة ومعدلة
تدور الأحداث من منظور الشينيغامي ريوك وهو يروي قصة الصراع بين لايت ياغامي والعبقري إل لشينيغامي آخر مجهول الهوية
يركز هذا الإصدار على المواجهة الذهنية والذكاء الخارق بين الطرفين من بداية حصول لايت على مذكرة الموت حتى نهاية الصراع الأول مع إل
يتضمن الفيلم مشاهد إضافية وتفاصيل لم تظهر في المسلسل الأصلي مع تعديلات في الإخراج والموسيقى لتجربة جديدة ومكثفة.",
